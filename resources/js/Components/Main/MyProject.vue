...
// Умное отображение категорий: максимум 2 + счётчик
...
<template>
    ...
    >
        ...
        <div class="p-4 flex flex-col gap-3 flex-grow">
            ...
            <!-- Категории: без фиксированной высоты, но с переносом и обрезкой -->
            ...
            <div v-if="project.status !== 'Отклонен' && project.status !== 'Заблокирован'" class="mt-auto pt-2" @click.stop>
                <button 
                    @click="editProject" 
